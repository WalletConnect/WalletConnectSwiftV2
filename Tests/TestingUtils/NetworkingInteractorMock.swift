...
public class NetworkingInteractorMock: NetworkInteracting {
    ...
    public let requestPublisherSubject = PassthroughSubject<(topic: String, request: RPCRequest, rawRequest: String?, publishedAt: Date, derivedTopic: String?), Never>()
    ...
    public var requestPublisher: AnyPublisher<(topic: String, request: JSONRPC.RPCRequest, rawRequest: String?, publishedAt: Date, derivedTopic: String?), Never> {
