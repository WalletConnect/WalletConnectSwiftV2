...
//    var networkingInteractor: NetworkingInteractor!
...
//        networkingInteractor = NetworkingInteractor(relayClient: relayClient, serializer: serializer, logger: logger, rpcHistory: RPCHistory(logger: logger, keyValueStore: CodableStore<RPCHistory.Record>(defaults: RuntimeKeyValueStorage(), identifier: "")))
//    }
//
