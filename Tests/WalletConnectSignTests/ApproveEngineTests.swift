...
final class ApproveEngineTests: XCTestCase {
    ...
    func testApproveProposal() async throws {
        ...
        pairingRegisterer.subject.send(RequestSubscriptionPayload(id: RPCID("id"), topic: topicA, request: proposal, rpcRequest: RPCRequest(method: "", id: ""), publishedAt: Date(), derivedTopic: nil))
    ...
    func testHandleSessionSettle() {
        ...
        networkingInteractor.requestPublisherSubject.send((sessionTopic, RPCRequest.stubSettle(), Date(), nil))
