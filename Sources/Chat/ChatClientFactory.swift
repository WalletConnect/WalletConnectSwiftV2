...
public struct ChatClientFactory {
    ...
    public static func create(
        ...
        let messageStore = NewKeyedDatabase<Message>(storage: storage, identifier: ChatStorageIdentifiers.messages.rawValue)
        let receivedInviteStore = NewKeyedDatabase<ReceivedInvite>(storage: storage, identifier: ChatStorageIdentifiers.receivedInvites.rawValue)
