...
public struct AnyCodable {
    ...
    public func get<T: Codable>(_ type: T.Type) throws -> T {
        let valueData = try dataRepresentation()
    ...
    private func dataRepresentation() throws -> Data {
...
extension AnyCodable: Equatable {
    ...
    public static func == (lhs: AnyCodable, rhs: AnyCodable) -> Bool {
        do {
            let lhsData = try lhs.dataRepresentation()
            let rhsData = try rhs.dataRepresentation()
